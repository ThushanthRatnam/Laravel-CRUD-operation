                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <table class="table table-bordered table-view">
                                ...
                                <tr><th>Brand</th> <td>{{$singleData->brand}}</td> </tr>
                                <tr><th>Import Frome</th> <td>{{$singleData->import_from}}</td> </tr>
                                <tr><th>Unit Price</th> <td>{{number_format($singleData->unit_price,2)}}</td> </tr>
