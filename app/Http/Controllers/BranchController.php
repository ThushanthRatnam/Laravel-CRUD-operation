...
class BranchController extends Controller
{
    ...
    public function post_add(Request $request)
    {
        ...
        $sessionMsg = $this->data->branch_name;
        return redirect('branch/'.$dataId.'/view')->with('success', 'Data '.$sessionMsg.' has been created');
    }
    ...
    public function post_edit(Request $request, $id)
    {
        ...
        $sessionMsg = $this->data->branch_name;
        return redirect('branch/'.$id.'/view')->with('success', 'Data '.$sessionMsg.' has been updated');
    }
